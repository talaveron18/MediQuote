...
log_step_start "Database setup (generate + push + seed)"
echo "[BUN] Generating Prisma client..."
bunx prisma generate
echo "[BUN] Pushing schema to database..."
bunx prisma db push
echo "[BUN] Seeding database..."
bun run seed
echo "[BUN] Database setup complete."
log_step_end "Database setup (generate + push + seed)"
